use crate::{
    ...
    supports_scalar_ops, supports_shift_ops, supports_value_type_conversion, Area, DynamicUnits,
    Length, LengthUnit, Scalar,
};
...
supports_cancellation!(Volume<A1>, Volume<A2>, LengthUnit);
